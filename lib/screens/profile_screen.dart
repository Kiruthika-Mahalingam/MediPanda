...
//             child: ListBody(
//               children: [
//                 _buildProfileDetail("Full Name", nameController.text),
//                 _buildProfileDetail("Date of Birth", dobController.text),
//                 _buildProfileDetail("Gender", selectedGender ?? "Not Selected"),
//                 _buildProfileDetail("Phone", phoneController.text),
//                 _buildProfileDetail("Email", emailController.text),
//                 _buildProfileDetail("Address", addressController.text),
//                 _buildProfileDetail("City", cityController.text),
//                 _buildProfileDetail("State", stateController.text),
//                 _buildProfileDetail("Country", selectedCountry ?? "Not Selected"),
//                 _buildProfileDetail("Zip Code", zipController.text),
//               ],
//             ),
//           ),
//           actions: [
...
//             onPressed: _showProfileDetails, // Opens the profile details dialog
//           ),
//         ],
//       ),
//       body: Container(
...
//               ElevatedButton(
//                 onPressed: () {
//                   // Move to the next screen (Medical Info)
//                 },
//                 style: ElevatedButton.styleFrom(
//                   backgroundColor: Colors.white,
//                   foregroundColor: const Color(0xFF203c8c),
...
//   Widget _buildDropdown(IconData icon, String label, List<String> items, String? selectedValue, ValueChanged<String?> onChanged) {
//     return Padding(
//       padding: const EdgeInsets.only(bottom: 15.0),
//       child: DropdownButtonFormField<String>(
//         decoration: InputDecoration(
...
class ProfileScreen extends StatefulWidget {
  ...
  ProfileScreen({this.showNextButton = true}); // Default is true
